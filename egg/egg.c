...
#define EGG_WINDOW_CAPTION_NAME _T("Perfect elevator system               Made by FGF team")
...
static BOOL InitEggWindow(int fWidth, int fHeight);
...
void EggStart(int fWidth, int fHeight)
{
...
static BOOL InitEggWindow(int fWidth, int fHeight)
{
    ...
    ChangeClientSizeTo(fWidth, fHeight);
...
static HWND CreateEggWindow(void)
{
    ...
    hwnd = CreateWindow (
               ...
               EGG_WINDOW_CAPTION_NAME,   // window caption
